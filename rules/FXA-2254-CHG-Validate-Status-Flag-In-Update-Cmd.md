# CHG-2254: Validate-Status-Flag-In-Update-Cmd
...
`af update DOC --status InvalidValue` silently writes invalid statuses. Only `--spec`-sourced updates are validated. Per PRP FXA-2253.
