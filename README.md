...
- **Issue Body Linting** — `af issue lint <body-file>` flags TBD-after-PR-review anti-patterns before issue creation (Phase 1 MVP — 5 canonical phrases; `--json` machine output; `-` reads stdin)
