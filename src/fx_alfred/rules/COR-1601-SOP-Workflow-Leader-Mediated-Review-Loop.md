...
| 2026-08-12 | CHG FXA-2323: declare revise-cycle back-edge (7→4, max 5 per §Iteration Mode default) per COR-1005; step 7 body now carries the §Termination Criteria final call (Leader resolves via step 6 options) | Claude Code |
