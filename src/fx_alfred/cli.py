...
@click.group(
    ...
    lazy_subcommands={
        ...
        "log": "fx_alfred.commands.log_cmd:log_cmd",
        "log-archive": "fx_alfred.commands.log_archive_cmd:log_archive_cmd",
        "log-validate": "fx_alfred.commands.log_validate_cmd:log_validate_cmd",
        "list": "fx_alfred.commands.list_cmd:list_cmd",
        "plan": "fx_alfred.commands.plan_cmd:plan_cmd",
        "projects": "fx_alfred.commands.projects_cmd:projects_cmd",
        "read": "fx_alfred.commands.read_cmd:read_cmd",
        "register": "fx_alfred.commands.register_cmd:register_cmd",
        ...
        "star": "fx_alfred.commands.star_cmd:star_cmd",
        "starred": "fx_alfred.commands.star_cmd:starred_cmd",
        "status": "fx_alfred.commands.status_cmd:status_cmd",
        "tag": "fx_alfred.commands.tag_cmd:tag_cmd",
        "unstar": "fx_alfred.commands.star_cmd:unstar_cmd",
